...
COUNTER=1
MAX_RETRY=5
export MAXBATCHSIZEPATH=".channel_group.groups.Application.policies.Admins.policy.value.identities"
...
#jq -s "$MAXBATCHSIZEPATH" config.json ./scripts/newPolicy.json > modified_config.json
#exit 1
set +x
